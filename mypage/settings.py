...
SECRET_KEY = 'django-insecure-_2i&10rg^%)(x!lq93#fsdw54x+(q*i_*b5y8d#i)_casj-(x8'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', 'https://rfidesign.herokuapp.com/']
...
# Email Settings for local host
#EMAIL_HOST = 'localhost'
#EMAIL_PORT = '1025'
#EMAIL_HOST_USER = ''
#EMAIL_HOST_PASSWORD = ''
#EMAIL_USE_TLS = False #Security perpose
#EMAIL_USE_SSL = False #Security perpose

# Email Settings for real hosting
